...
Позиционирование portrait, текста и continue marker построено вокруг одного anchor:
...
Portrait, текст и marker настраиваются как независимые зоны внутри одного textbox.
...
Анимация разговора привязана к **реальному reveal символов** через `Scribble typist.function_per_char(...)`.
