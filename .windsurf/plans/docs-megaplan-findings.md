...
**Критические расхождения (фантомные функции):**

| Функция | Где в docs | Статус в коде |
|---------|-----------|---------------|
| `scr_facing_to_sprite` | `code-reference/gml-scripts.md` | **Не существует** |
| `scr_sprite_to_facing` | `code-reference/gml-scripts.md` | **Не существует** |
| `interactionWithNPCsOrObjects` | `systems/interaction.md` | **Не существует** |
| `interactionWithMainCast` | `systems/interaction.md` | **Не существует** |
| `scr_interaction` | `systems/interaction.md` | Не найден как отдельный скрипт (возможно inline в объектах NPC) |
